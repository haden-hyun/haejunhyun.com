 ...
 *
 * - 사이드바(320px 고정)가 아닌 본문 폭에 둔다. 2열 카드 그리드에 필요한 폭
 * - 우측 사이드바의 backlinks 플러그인과 공존한다
 *
 * 주의: 위키링크 일부가 부분 슬러그로 저장돼 대상을 못 찾는다. 그런 링크는 조용히
 * 건너뛴다(깨진 카드를 만들지 않는다). 근본 수정은 vault 쪽 표기 정리.
 */
