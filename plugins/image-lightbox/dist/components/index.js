...
var imageLightbox_inline_default = 'document.addEventListener("nav",()=>{let e=document.getElementById("lightbox-overlay");if(!e){e=document.createElement("div"),e.id="lightbox-overlay";let o=document.createElement("img");o.id="lightbox-img",e.appendChild(o),document.body.appendChild(e)}let n=()=>{e.classList.remove("active"),document.body.style.overflow=""};e.addEventListener("click",n),window.addCleanup(()=>e.removeEventListener("click",n));for(let o of document.querySelectorAll("article img")){let t=o;t.style.cursor="zoom-in";let l=()=>{let d=document.getElementById("lightbox-img");d.src=t.src,d.alt=t.alt,e.classList.add("active"),document.body.style.overflow="hidden"};t.addEventListener("click",l),window.addCleanup(()=>t.removeEventListener("click",l))}});\n';
var l;
function S(n2) {
  return n2.children;
}
