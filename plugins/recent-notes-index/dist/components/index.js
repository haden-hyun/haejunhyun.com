...
var RecentNotesForIndex_default = ((userOpts) => {
  ...
  const RecentNotesForIndex = ({
    ...
    const pages = files.filter(opts.filter).filter((f3) => f3.slug !== fileData.slug && f3.frontmatter?.title).sort(opts.sort).slice(0, opts.limit);
    ...
    return /* @__PURE__ */ u2("div", { class: classNames(displayClass, "recent-notes"), children: [
      ...
      /* @__PURE__ */ u2("div", { class: "notes-grid", children: pages.map((page) => {
        ...
        return /* @__PURE__ */ u2("a", { class: "note-card", "data-category": catKey, href: resolveRelative(fileData.slug, page.slug), children: [
